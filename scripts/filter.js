...
fetch("https://api.jsonbin.io/v3/b/6623e252acd3cb34a83bcc2b")
    .then(result => result.json())
    .then(resultObj => { 

        const rawItems = resultObj.products;
        ...
        const makeupHTML = makeupHTMLArray.reduce((prev, current) => prev + current," ");
