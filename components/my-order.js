class OrderPay extends HTMLElement {
    ...
    render() {
        ...
        <section class="orders-section flexrow">
            ...
            <div class="info">
                ...
                <div class="orderBtn flexrow">
                    <button class="order-day">Өдөр сонгох</button>
                    <div class="day-selection hidden">
        ...
        this.querySelector('.order-day').addEventListener('click', () => {
            this.querySelector('.day-selection').classList.toggle('hidden');
        });
        ...
        this.querySelectorAll('.order-hour').forEach(button => {
            button.addEventListener('click', (event) => {
                ...
                this.querySelectorAll('.order-hour').forEach(btn => btn.classList.remove('selected'));
        ...
        this.querySelector('.verify-btn').addEventListener('click', async () => {
            if (this.selectedDay && this.selectedHour) {
                alert(`Selected day: ${this.selectedDay}, Selected hour: ${this.selectedHour}`);
                try {
